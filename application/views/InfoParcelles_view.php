                ...
                <?php foreach ($parcelles as $ligne) { ?>
                    ...
                    <div class="card card-cascade m-3">
                        ...
                        <div class="view view-cascade gradient-card-header cloudy-knoxville-gradient black-text">
                            ...
                            <!-- Title -->
                            <h2 class="card-header-title mb-3"><?php echo $ligne->parcelle_titre ?></h2>
                        ...
                        <div class="card-body card-body-cascade text-center">
                            ...
                            <!-- Text -->
                            <p class="card-text"><?php echo $ligne->parcelle_sources_1646 ?></p>

                            <p class="card-text"><?php echo $ligne->parcelle_sources_1673 ?></p>

                            <p class="card-text"><?php echo $ligne->parcelle_sources_18eme ?></p>
